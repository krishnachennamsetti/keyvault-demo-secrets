...
public class KeyvaultController {
    ...
    public ResponseEntity<String> fetchAADToken() throws MalformedURLException {
        ...
        IAuthenticationResult result = clientApplication.acquireToken(ClientCredentialParameters.builder(Collections.singleton("https://krishnachennamsettigmail.onmicrosoft.com/.default")).build()).join();
