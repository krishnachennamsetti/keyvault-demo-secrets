...
public class KeyvaultController {
    ...
    public ResponseEntity<String> fetchAADToken() throws MalformedURLException {
        ...
        IAuthenticationResult result = clientApplication.acquireToken(ClientCredentialParameters.builder(Collections.singleton("api://850e9b80-3b92-43e6-add5-4cc1661d1ad3/.default")).build()).join();
